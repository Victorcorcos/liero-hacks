...
weapons = {
  ...
  "h_k_g3_sg_1": {
    ...
    "bulletType":1,
    "bulletSpeed":3.6,
    "bulletSpeedInherit":0.2777777777777778,
  ...
  "machinepistol": {
    ...
    "bulletSpeed":3.5,
    "bulletSpeedInherit":0,
    "distribution":0.2558441162109375,
    "recoil":0.15,
    "ammo":30,
    "delay":5,
    "loadingTime":520,
  ...
  "proxymine": {
    ...
    "bulletType":6,
    "bulletSpeed":1.3,
    "bulletSpeedInherit":0.7692307692307692,
  ...
  "glock18burstf": {
    ...
    "bulletType":7,
    "bulletSpeed":3.2,
    "bulletSpeedInherit":0.3125,
    "distribution":0.3204345703125,
    "recoil":0.22,
    "ammo":7,
    "delay":32,
    "loadingTime":460,
  ...
  "cluster_mine": {
    ...
    "bulletType":8,
    "bulletSpeed":3.58,
    "bulletSpeedInherit":0.27932960893854747,
  ...
  "flamer": {
    ...
    "bulletType":9,
    "bulletSpeed":3.4,
    "bulletSpeedInherit":0.29411764705882354,
  ...
  "20mmautocanno": {
    ...
    "bulletType":11,
    "bulletSpeed":3.5,
    "bulletSpeedInherit":0.2857142857142857,
    "distribution":0.4425048828125,
    "recoil":0.2,
    "ammo":20,
    "delay":25,
    "loadingTime":400,
  ...
  "air_mine": {
    ...
    "bulletType":13,
    "bulletSpeed":2.4,
    "bulletSpeedInherit":0.4166666666666667,
    "distribution":0.0030517578125,
    "recoil":0,
    "ammo":5,
    "delay":120,
    "loadingTime":1000,
  ...
  "kalashnikov47": {
    ...
    "bulletType":14,
    "bulletSpeed":3.3,
    "bulletSpeedInherit":0.30303030303030304,
    "distribution":0.3509521484375,
    "recoil":0.25,
    "ammo":30,
    "delay":7,
    "loadingTime":800,
  ...
  "force_field": {
    ...
    "bulletType":19,
    "bulletSpeed":3.7,
    "bulletSpeedInherit":0.27027027027027023,
    "distribution":0.00006103515625,
    "recoil":0,
    "ammo":1,
    "delay":0,
    "loadingTime":700,
  ...
  "combat_knife": {
    ...
    "distribution":0.003814697265625,
    "recoil":0,
    "ammo":6,
    "delay":16,
    "loadingTime":200,
  ...
  "grenade": {
    ...
    "bulletType":25,
    "bulletSpeed":2.44,
    "bulletSpeedInherit":0.4098360655737705,
    "distribution":0.1068115234375,
    "recoil":0.14,
    "ammo":2,
    "delay":150,
  ...
  "clusterbomb": {
    ...
    "bulletType":27,
    "bulletSpeed":2,
    "bulletSpeedInherit":0.5,
    "distribution":0.06103515625,
    "recoil":0.2,
    "ammo":2,
    "delay":150,
    "loadingTime":900,
  ...
  "excimer_laser": {
    ...
    "bulletSpeed":3,
    "bulletSpeedInherit":0,
    "distribution":0.000762939453125,
    "recoil":0,
    "ammo":75,
    "delay":5,
    "loadingTime":500,
...
liero_config = {
   ...
   "nObjects":[
      ...
      {
         "detectDistance":9,
         "gravity":0.01373291015625,
         "speed":4,
         "speedV":0,
         "distribution":0.498291015625,
         "blowAway":0.2,
         "bounce":0,
         "hitDamage":1,
         "wormExplode":true,
      ...
      {
         "detectDistance":1,
         "gravity":-0.003387451171875,
         "speed":1.2,
         "speedV":0.4,
         "distribution":0.457763671875,
         "blowAway":0,
         "bounce":0.2,
         "hitDamage":4,
         "wormExplode":true,
...
def create_file(liero_config)
  file = File.new('mod.json', 'w')
  file.puts(JSON.pretty_generate(liero_config))
  file.close
end

create_file(liero_config)
